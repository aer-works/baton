...
/// <summary>
/// The binding-inheritance rule behind <c>aer redispatch</c> with no <c>--spec</c> (#1441):
...
/// <see cref="Aer.Adapters.Tests.RoleDispatchTests"/> already does for <see cref="RoleDispatch.ToBinding"/>.
/// </summary>
