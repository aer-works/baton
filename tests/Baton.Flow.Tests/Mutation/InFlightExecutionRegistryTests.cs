...
/// <see cref="Baton.Flow.Mutation.MutationInterface"/> pump involved), covering the race
...
public class InFlightExecutionRegistryTests
{
    ...
    /// load-bearing when <c>Baton.Flow.CrashTestHost.Program</c>'s signal watcher started retrying on
