...
namespace Baton.Flow.Tests.Dispatch;
...
public class CoreDispatcherTests
{
    ...
    /// vendor-specific variable (e.g. Claude Code's subagent depth cap) without <c>Baton.Flow</c> ever
    ...
    public void Mostly_whitespace_stderr_is_retained_in_the_same_units_the_display_cap_measures()
    {
        ...
        Assert.True(
            captured.Length > Baton.Flow.Outcomes.OutcomeClassifier.MaxStderrTailInReason,
