...
public class CrashRecoveryEndToEndTests
{
    ...
    public async Task A_host_killed_while_its_real_child_is_still_running_leaves_the_attempt_abandoned_and_retried_on_recovery()
    {
        ...
        {
            // Best-effort belt-and-braces: the OS Job Object backing BatonTask's process-tree
            // containment already took the orphan down alongside the host process
            ...
            // this is reliably already a no-op, not a real cleanup.
