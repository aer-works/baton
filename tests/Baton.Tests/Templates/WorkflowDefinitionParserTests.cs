...
public class WorkflowDefinitionParserTests
{
    ...
    public void Every_converter_reachable_from_the_template_graph_is_known_to_the_prefix_list()
    {
        ...
        {
            "Baton.Domain.BackoffPolicyJsonConverter",
            "Baton.Domain.StepId+Converter",
            "Baton.Domain.WorkflowTemplateId+Converter",
        };
        ...
        void Walk(Type type)
        {
            ...
            if (type.Namespace?.StartsWith("Baton", StringComparison.Ordinal) != true
                || !visited.Add(type))
            {
                return;
            }
