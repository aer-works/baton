...
/// <see cref="Aer.Tests.Shared.FileCleanup"/> — the file counterpart of
/// <see cref="Aer.Tests.Shared.DirectoryCleanup"/> — so a bare delete racing a transient Windows
...
public class FileDeleteHygieneTests
{
    ...
    public void All_test_file_single_file_deletes_route_through_FileCleanup()
    {
        ...
        var allowed = new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "Aer.Flow.Tests/CleanupHelpersTests.cs",
        };
        ...
        Assert.True(
            ...
            "All single-file deletes in tests must route through Aer.Tests.Shared.FileCleanup " +
