...
/// <see cref="Aer.Tests.Shared.DirectoryCleanup.DeleteRecursively"/> to prevent Windows transient file lock flakes.
/// </summary>
public class DirectoryDeleteHygieneTests
{
    ...
    public void All_test_file_recursive_deletes_route_through_DirectoryCleanup()
    {
        ...
        Assert.True(
            ...
            "All raw recursive deletes in tests must route through Aer.Tests.Shared.DirectoryCleanup.DeleteRecursively (#438), " +
