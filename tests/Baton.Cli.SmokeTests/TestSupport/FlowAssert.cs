...
/// three test projects hold no project reference to each other. Most valuable here of anywhere in
/// the repo: a red live-vendor smoke test is also a spent, non-reproducible run.
/// </summary>
