...
| `baton deliver <file> [--title <text>] [--room <room-dir>]` | Deliver an orchestrator artifact into a room (defaults to standing conductor room) so it reaches the Fleet Glass inbox. |
