| | `agy` 1.1.11 *(carried, not re-probed)* | `claude` 2.1.226 (Claude Code) |
|---|---|---|
| plan usage & reset | not found on: --help, subcommand list, in-session slash command | **`/usage` — 19% used, with reset times** |
