| | `claude` 2.1.222 (Claude Code) *(carried, not re-probed)* | `agy` 1.1.11 |
|---|---|---|
| plan usage & reset | **`/usage` — 13% used, with reset times** | not found on: --help, subcommand list, in-session slash command |
