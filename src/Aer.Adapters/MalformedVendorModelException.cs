...
/// dispatch pump), so it surfaces at Aer.Cli's top-level <c>catch (AerFlowException)</c> and never
...
/// </summary>
public sealed class MalformedVendorModelException : AerFlowException
{
