...
public static class LedgerCsv
{
    ...
    [
        ...
        "runwayOverrideReason", "verdict", "findingsHigh", "findingsMedium", "findingsLow", "reviewedPr",
        "reviewedHead", "filesChanged", "additions", "deletions", "testFilesChanged", "resolution",
        "resolutionReason",
    ];
