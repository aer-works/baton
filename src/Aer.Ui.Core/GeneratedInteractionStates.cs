...
public static class InteractionStatePresentation
{
    ...
    public static string DisplayName(this InteractionState state) => state switch
    {
        ...
        InteractionState.WaitingOnLock => "Waiting on another process's lock",
