...
public sealed partial class RoomClient
{
    ...
    internal static RoomProjection ToProjection(ProjectionFrame frame) =>
        new(frame.Snapshot, frame.State, frame.History, frame.Lineage, frame.PendingPermission, frame.PermissionAnswers, frame.DormancyTransitions, frame.StepPauseMoments, frame.RecordedDecisionMoments, frame.IsWorkflowOff);
