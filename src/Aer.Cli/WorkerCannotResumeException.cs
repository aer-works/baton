...
/// <summary>
/// <c>aer resume</c> (issue #1359) refuses loudly rather than silently starting cold when the
...
/// yet capture a vendor session id into the room ledger on their own (that capture is aer-works/baton#1381's
...
/// </summary>
public sealed class WorkerCannotResumeException : AerFlowException
{
