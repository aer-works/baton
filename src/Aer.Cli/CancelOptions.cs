...
/// <summary>
/// Parsed arguments for <c>aer cancel</c> (M12 Phase 2), the on-demand cancellation surface exposed
/// on the CLI.
/// </summary>
/// <param name="RoomDirectoryPath">
/// An already-started room's durable state directory — <c>aer cancel</c> never binds a fresh
/// snapshot the way <c>aer run</c> does ("mutation commands never bind fresh" rule).
/// </param>
