...
/// presentation layer rather than <c>Aer.Flow</c> — the same boundary, and the same layer's
/// current home, that <see cref="RoomProjection"/>'s own doc comment explains (M14 Phase 1,
/// UI spec §2).
/// </summary>
