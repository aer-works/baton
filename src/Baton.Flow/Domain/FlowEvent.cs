...
public abstract record FlowEvent
{
    ...
    /// <see cref="Baton.Flow.Outcomes.OutcomeClassifier"/>), distinct from <paramref name="FailureClassification"/>'s
    ...
    /// <see cref="Baton.Flow.Store.FlowEventLogJson.Options"/>, under which a constructor parameter
