...
/// <c>Baton.Flow.Templates</c>, not in a caller's assembly (the desktop app that originally owned
...
/// template on any execution path — this type has no caller inside <c>Baton.Flow</c> itself; today's
