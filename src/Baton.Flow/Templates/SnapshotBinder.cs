...
public static class SnapshotBinder
{
    ...
    /// elapsed time, not attempt count, for the anti-starvation reason <c>Baton.Vendors.AtomicLaunchConfigWriter</c>
    ...
    /// <c>Baton.Vendors.AtomicLaunchConfigWriter</c>, applied there to worker launch configs).
    ...
    /// <summary>
    /// Reads back a snapshot persisted by <see cref="PersistAsync"/> — how a resumed <c>baton run</c>
