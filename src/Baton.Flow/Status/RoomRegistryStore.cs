...
// Lives in Baton.Flow, not Baton.Vendors: fleet_status (Baton.Mcp.Host) needs to read this registry
...
/// <c>FileShare.Read</c> (an exclusive write lock, the same choice <see cref="Baton.Flow.Store.FlowEventLogWriter"/>
