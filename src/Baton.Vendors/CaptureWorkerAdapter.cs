...
/// run entrypoint at workflow start (the git-aware place, mirroring what <c>tools/baton-agy-loop/dispatch.py</c>'s
/// <c>head_before</c> did before #1759 retired it). It is diffed against the working tree, not <c>base..HEAD</c> — decision 0047 §4
