...
/// </summary>
public sealed class UnisolatedGrantAuditException : BatonFlowException
{
            ...
            "provisioned does not; an audit against a shared working directory would see unrelated dirt or miss nothing.")
    {
        ...
        TryInvocation = "use 'baton dispatch <role>' to auto-provision an isolated workspace, or add a \"Worktree\" " +
            "spec to this worker's bindings.json entry and run it through 'baton run', which provisions it -- a " +
